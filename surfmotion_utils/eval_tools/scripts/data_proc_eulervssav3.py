...
for planner in planners:
    ...
    axes[0].plot(time, v_savgol_mag, linestyle="-", color=color, alpha=0.85, label=f"{label_base} (Savitzky)")
...
fig.suptitle("Euler vs. Savitzky-Golay (UR20)", fontsize=18, y=0.98, x=0.53)
